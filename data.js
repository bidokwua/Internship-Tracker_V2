...
const SEED_DATA = [
  ...
  },
  {
    ...
    notes: "Quant trading firm, Chicago. Rejected July 1 — moved forward with more aligned candidates. Advised to wait a year before reapplying.",
    followUpDate: "",
    deadline:      "",
    contactName:   "",
    contactEmail:  "",
  ...
  },
  {
    id: 4,
    company: "Salesforce",
    role: "LATAM Internship Program - Salesforce Technical Consulting Intern",
    dateApplied: "2026-07-01",
    emailUsed: "bidokwua@carleton.edu",
    status: "Applied",
    link: "https://salesforce.wd12.myworkdayjobs.com/External_Career_Site",
    notes: "Part-time, office-flexible role based in Bogota, Colombia. LATAM-specific Futureforce program focused on Salesforce/Apex/AI development. Auto-confirmation received immediately.",
